...
const Sidebar = () => {
    ...
    return (
        <div className='md:w-64 w-16 border-r h-full text-base border-gray-300 pt-4 flex flex-col transition-all duration-300'>
           ...
           ${isActive ? "border-r-4 md:border-r-[6px] bg-blue-600/10 border-blue-600 text-blue-600" : "text-gray-700 hover:bg-gray-100/90 border-white"}`
                    }
                >
...
//     return (
//         <div className='h-full border-r border-gray-300 flex flex-col pt-4 transition-all duration-300 md:w-64 w-16 text-base bg-white'>
//             {sidebarLinks.map((item, index) => (
//                 <NavLink
//                     to={item.path}
//                     key={index}
